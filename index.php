...
$full_text = [
    ...
    'АГРЕГАТ ДЛЯ СБОРА КОНДЕНСАТА НЕФТИ',
        ...
        <div id="advantagesSliderWrapper">
            ...
            <div id="advantagesSlider">
                ...
                <div class="slides">
                    <div class="slide">
                        <div>
                            <img src="img/advantagesSliderImg/1img.jpg">
                            <h4>Различные варианты базы.</h4>
                            <p>Изготовление цистерн на шасси КАМАЗ, Урал, МАЗ, на прицепах и в автономном исполнении.</p>
                        </div>
                        <div>
                            <img src="img/advantagesSliderImg/2img.jpg">
                            <h4>Модели устанавливаемых вакуумных насосов</h4>
                            <p>КО – 505А, КО – 510, PNR – 122 D</p>
                        </div>
                        <div>
                            <img src="img/advantagesSliderImg/3img.jpg">
                            <h4>Варианты исполнения вакуумных цистерн:</h4>

                            <ul>
                                    <li>без открывания заднего днища</li>
                                    <li>с очистным люком Ду700мм в заднем днище</li>
                                    <li>с механическим открыванием заднего днища</li>
                            </ul>

                        </div>
                    </div>
                    <div class="slide">
                        <div><img src="img/advantagesSliderImg/4img.jpg" alt="">
                            <h4>Надежная конструкция цистерны.</h4>
                            <p>Цистерна производится только из низколегированной стали марки 09Г2С толщиной от 4 до 6 мм. Снаружи дополнительно усилена шпангоутами.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/5img.jpg" alt="">
                            <h4>Поясное крепление цистерн.</h4>
                            <p>Крепление цистерны к надрамнику осуществляется металлическими стяжными лентами, что исключает порывы цистерны и надрамника при движении по бездорожью.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/6img.jpg" alt="">
                            <h4>Волнорезы усиленные.</h4>
                            <p>Необходимы для уменьшения гидравлических ударов, создаваемых перевозимой жидкостью при движении автомобиля с переменной скоростью.</p>
                        </div>
                    </div>
                    <div class="slide">
                        <div><img src="img/advantagesSliderImg/7img.jpg" alt="">
                            <h4>Система электронной отсечки.</h4>
                            <p>глушит двигатель авто при заполнении цистерны, электронная отсечка позволяет избежать попадания закаченной жидкости в насос.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/8img.jpg" alt="">
                            <h4>Удобная система управления.</h4>
                            <p>Управление коробкой отбора мощности, вакуумным насосом, электронной отсечкой, световым оборудованием автоцистерны происходит из кабины машины.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/9img.jpg" alt="">
                            <h4>Стрелочный мановакуумметр.</h4>
                            <p>Служит для определения величины ражряжения, создаваемого вакуумным насосом внутри цистерны при закачке и давления при выкачке.</p>
                        </div>
                    </div>
                    <div class="slide">
                        <div><img src="img/advantagesSliderImg/10img.jpg" alt="">
                            <h4>Площадка для обслуживания насоса и горловины </h4>
                            <p>выполнены из просечного листа для противоскользящего эффекта.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/11img.jpg" alt="">
                            <h4>Дополнительная заливная горловина </h4>
                            <p>для большей универсальности вакуумных машин, позволяет использовать их как «наливники» для транспортировки сырой нефти, технической воды и других жидкостей.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/12img.jpg" alt="">
                            <h4>Подогрев сливного люка с задвижкой от системы выхлопных газов шасси </h4>
                            <p>для транспортировки технической воды. В системе установлен затвор для включения/выключения обогрева в зависимости от времени года и температуры окружающей среды</p>
                        </div>
                    </div>
                    <div class="slide">
                        <div><img src="img/advantagesSliderImg/13img.jpg" alt="">
                            <h4>Смотровое окно </h4>
                            <p>находится в верхней части заднего днища и служит для визуального контроля наполнения цистерны.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/14img.jpg" alt="">
                            <h4>Защитный металлический фартук </h4>
                            <p>установлен под сливным люком и необходим для предотвращения пролива жидкости на запасное колесо, противооткатный брус и фары.</p>
                        </div>
                        <div><img src="img/advantagesSliderImg/15img.jpg" alt="">
                            <h4>Пеналы и держатели для рукава.</h4>
                            <p>В транспортном положении напорно-всасывающий рукав укладывается в металлический пенал и держатели по бокам цистерны.</p>
                        </div>
                    </div>
                </div>
                <div class="arrow right-arrow"><i class="fa fa-arrow-circle-o-right  fa-4x"></i></div>
